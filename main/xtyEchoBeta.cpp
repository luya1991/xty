...
int main()
{
	...
	g_session_pointer = new xtySession("echo-beta", xtyPool::GetInstance());

	if (g_session_pointer)
		g_session_pointer->Start();

	// make sure that 'echo-alpha' is already online
	sleep(5);
	...
	{	
		...
		smsg.m_ToProcessName = "echo-alpha";
		smsg.m_Content = "beta says hello to alpha";
